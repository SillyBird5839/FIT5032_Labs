...
namespace MyDatePicker.Controllers
{
    public class HealthCareAppointmentsController : Controller
    {
        ...
        */
        ...
        /*
        [HttpPost]
        public String CreateAppointment(int PatientID, int DoctorID, string Date)
        {
        ...
        */
        ...
        public String CreateAppointment()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                mail.From = new MailAddress("fit5032ydai20240801@outlook.com");
                ...
                smtp.Credentials = new System.Net.NetworkCredential
                    ("fit5032ydai20240801@outlook.com", "MYSecret");
                smtp.Send(mail);
                return "Success";
            }
            return "Database Unavailable.";
